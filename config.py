...
BACKUP_OPENAI_CONFIG = {
    ...
    "base_url": os.getenv("BACKUP_OPENAI_BASE_URL", "https://api.chatanywhere.tech/v1"),
    "model": os.getenv("BACKUP_OPENAI_MODEL", "gpt-4o-mini-2024-07-18"),
    "timeout": 60,
    "temperature": 0.1
}
...
PINECONE_CONFIG = {
    ...
    "index_name": os.getenv("PINECONE_INDEX_NAME", "medical-records"),
